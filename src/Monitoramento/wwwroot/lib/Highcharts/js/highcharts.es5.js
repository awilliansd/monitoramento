...
(function (N, I) {
...
})("undefined" !== typeof window ? window : undefined, function (N) {
    var I = (function () {
        var a = "undefined" === typeof N ? "undefined" !== typeof window ? window : {} : N, y = a.document,
            ...
            k = /(edge|msie|trident)/i.test(F) && !a.opera, c = -1 !== F.indexOf("Firefox"),
            p = -1 !== F.indexOf("Chrome"), t = c && 4 > parseInt(F.split("Firefox/")[1], 10);
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            dSetter: function dSetter() {
                ...
                var t = this, v = t.options, w = function w(a) {
        ...
        a.merge = function () {
            var k, c = arguments, p, t = {}, v = function v(c, r) {
                "object" !== typeof c && (c = {});
        ...
        a.numberFormat = function (k, c, p, t) {
            k = +k || 0;
            c = +c;
            var v = a.defaultOptions.lang, w = (k.toString().split(".")[1] || "").split("e")[0].length, r, h,
    ...
    (function (a) {
        ...
        a.Color.prototype = {
            ...
            }], names: {white: "#ffffff", black: "#000000"}, init: function init(k) {
                var c, p, t, v;
    ...
    (function (a) {
        var y, F, G = a.addEvent, k = a.animate, c = a.attr, p = a.charts, t = a.color, v = a.css, w = a.createElement,
            r = a.defined, h = a.deg2rad, e = a.destroyObjectProperties, l = a.doc, n = a.extend, d = a.erase,
            g = a.hasTouch, b = a.isArray, x = a.isFirefox, u = a.isMS, H = a.isObject, E = a.isString, B = a.isWebKit,
            m = a.merge, z = a.noop, D = a.objectEach, A = a.pick, f = a.pInt, q = a.removeEvent, L = a.splat,
            K = a.stop, T = a.svg, J = a.SVG_NS, M = a.symbolSizes, R = a.win;
        ...
        n(y.prototype, {
            ...
            updateShadows: function updateShadows(a, f, q) {
                for (var C = this.shadows, d = C.length; d--;) q.call(C[d], "height" === a ? Math.max(f - (C[d].cutHeight || 0), 0) : "d" === a ? this.d : f, a, C[d]);
            },
            ...
            css: function css(a) {
                var C = this.styles, q = {}, d = this.element, b, g = "", e, m = !C,
            ...
            getBBox: function getBBox(a, f) {
                var q, C = this.renderer, d, b = this.element, g = this.styles, e, m = this.textStr, J, z = C.cache,
                    l = C.cacheKeys, x = b.namespaceURI === this.SVG_NS, c;
                f = A(f, this.rotation);
                d = f * h;
            ...
            fadeOut: function fadeOut(a) {
                var f = this;
                f.animate({opacity: 0}, {
                    duration: a || 150, complete: function complete() {
                        f.attr({y: -9999});
                    }
                });
            },
            ...
            destroy: function destroy() {
                var a = this, f = a.element || {}, q = a.renderer,
                    b = q.isSVG && "SPAN" === f.nodeName && a.parentGroup, g = f.ownerSVGElement, e = a.clipPath;
            ...
            shadow: function shadow(a, f, q) {
                ...
                if (!a) this.destroyShadows(); else if (!this.shadows) {
                    ...
                    for (C = 1; C <= m; C++) b = g.cloneNode(0), e = 2 * m + 1 - 2 * C, c(b, {
            ...
            zIndexSetter: function zIndexSetter(a, q) {
                ...
                if (e) {
                    ...
                    q = g.childNodes;
                    for (h = q.length - 1; 0 <= h && !C; h--) if ((d = q[h], e = d.getAttribute("data-z-index"), n = !r(e), d !== m)) if (0 > a && n && !b && !h) g.insertBefore(m, q[h]), C = !0; else if (f(e) <= a || n && (!r(a) || 0 <= a)) g.insertBefore(m, q[h + 1] || null), C = !0;
        ...
        n(F.prototype, {
            ...
            truncate: function truncate(a, f, q, b, d, g, e) {
                var m = this, n = a.rotation, h, C = b ? 1 : 0, J = (q || b).length, z = J, c = [], r = function r(a) {
                    f.firstChild && f.removeChild(f.firstChild);
            ...
            buildText: function buildText(a) {
                var q = a.element, b = this, d = b.forExport, g = A(a.textStr, "").toString(),
                    ...
                    K = C && "nowrap" === C.whiteSpace, L = C && C.fontSize, B, M, k = m.length,
                    C = z && !a.added && this.box, H = function H(a) {
                        var g;
                    ...
                    e || x || u || z || -1 !== g.indexOf(" ") ? (C && C.appendChild(q), e ? (g = b.styledMode ? g.replace(/<(b|strong)>/g, '\x3cspan class\x3d"highcharts-strong"\x3e').replace(/<(i|em)>/g, '\x3cspan class\x3d"highcharts-emphasized"\x3e') : g.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e'), g = g.replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g)) : g = [g], g = g.filter(function (a) {
                        ...
                        e.forEach(function (f) {
                            if ("" !== f || 1 === e.length) {
                                ...
                                (A = w(f, "href")) && !d && (c(x, "onclick", 'location.href\x3d"' + A + '"'), c(x, "class", "highcharts-anchor"), b.styledMode || v(x, {cursor: "pointer"}));
                                ...
                                if (" " !== f) {
                                    ...
                                    if (z) {
                                        ...
                                        }); else if (r) for (; B.length;) B.length && !K && 0 < A && (x = l.createElementNS(J, "tspan"), c(x, {
                                            dy: k,
                                            x: h
            ...
            image: function image(a, f, q, b, g, d) {
                var e = {preserveAspectRatio: "none"}, m, h = function h(a, f) {
            ...
            symbols: {
                circle: function circle(a, f, q, b) {
                    ...
                    var h = Math.cos(d), J = Math.sin(d), z = Math.cos(n), n = Math.sin(n);
            ...
            label: function label(f, b, g, d, e, h, J, z, x) {
                var l = this, c = l.styledMode, u = l.g("button" !== x && "label"),
                    ...
                    w = {}, p, t, R = /^url\((.*?)\)$/.test(d), v = c || R, P = function P() {
    ...
    (function (a) {
        ...
        c(h.prototype, {
            htmlCss: function htmlCss(a) {
                ...
                if (this.added) {
                    var a = this.renderer, d = this.element, g = this.translateX || 0, b = this.translateY || 0,
                        e = this.x || 0, h = this.y || 0, l = this.textAlign || "left",
                        c = ({left: 0, center: .5, right: 1})[l], B = this.styles, m = B && B.whiteSpace;
                    ...
                    if ("SPAN" === d.tagName) {
                        var B = this.rotation, z = this.textWidth && r(this.textWidth),
                            D = [B, l, d.innerHTML, this.textWidth, this.textAlign].join(), A;
        ...
        c(e.prototype, {
            getTransformKey: function getTransformKey() {
                ...
                var b = this.createElement("span"), n = b.element, u = b.renderer, l = u.isSVG, r = function r(a, b) {
    ...
    (function (a) {
        ...
        a.Time.prototype = {
            defaultOptions: {}, update: function update(a) {
    ...
    (function (a) {
        ...
        a.Tick.prototype = {
            addLabel: function addLabel() {
                var c = this, r = c.axis, h = r.options, e = r.chart, l = r.categories, n = r.names, d = c.pos,
                ...
                var c = this.axis, h = c.options.labels, e = a.x, l = c.chart.chartWidth, n = c.chart.spacing,
                    ...
                    u = g.getBBox().width, k = c.getSlotWidth(this), E = k, B = 1, m, z = {};
                ...
                var b = this.axis, x = b.transA, u = b.reversed, r = b.staggerLines, E = b.tickRotCorr || {x: 0, y: 0},
                    B = l.y, m = e || b.reserveSpaceDefault ? 0 : -b.labelOffset * ("center" === b.labelAlign ? .5 : 1),
                    z = {};
    ...
    var X = (function (a) {
        var y = a.addEvent, F = a.animObject, G = a.arrayMax, k = a.arrayMin, c = a.color, p = a.correctFloat,
            t = a.defaultOptions, v = a.defined, w = a.deg2rad, r = a.destroyObjectProperties, h = a.extend,
            e = a.fireEvent, l = a.format, n = a.getMagnitude, d = a.isArray, g = a.isNumber, b = a.isString,
            x = a.merge, u = a.normalizeTickInterval, H = a.objectEach, E = a.pick, B = a.removeEvent, m = a.splat,
            z = a.syncTimeout, D = a.Tick, A = function A() {
                this.init.apply(this, arguments);
            };
        a.extend(A.prototype, {
            ...
            defaultYAxisOptions: {
                ...
                stackLabels: {
                    allowOverlap: !1, enabled: !1, formatter: function formatter() {
            ...
            defaultLabelFormatter: function defaultLabelFormatter() {
                var f = this.axis, q = this.value, b = f.chart.time, g = f.categories, d = this.dateTimeLabelFormat,
                    e = t.lang, m = e.numericSymbols, e = e.numericSymbolMagnitude || 1E3, h = m && m.length, n,
                    c = f.options.labels.format, f = f.isLog ? Math.abs(q) : f.tickInterval;
            ...
            getPlotLinePath: function getPlotLinePath(a, q, b, d, m) {
                var f = this, h = f.chart, n = f.left, c = f.top, u, l, z, x,
                    ...
                    L = f.transB, A, B = function B(a, f, q) {
            ...
            adjustForMinRange: function adjustForMinRange() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (v(a.min) || v(a.max) ? this.minRange = null : (this.series.forEach(function (a) {
                    n = a.xData;
                    for (m = c = a.xIncrement ? 1 : n.length - 1; 0 < m; m--) if ((h = n[m] - n[m - 1], void 0 === e || h < e)) e = h;
            ...
            setAxisTranslation: function setAxisTranslation(a) {
                var f = this, g = f.max - f.min, d = f.axisPointRange || 0, m, h = 0, n = 0, c = f.linkedParent,
                    u = !!f.categories, l = f.transA, z = f.isXAxis;
            ...
            trimTicks: function trimTicks(a, b, g) {
                ...
                if (!this.isLinked) {
                    ...
                    if (g) this.max = d; else for (; this.max + q < a[a.length - 1];) a.pop();
            ...
            adjustTickAmount: function adjustTickAmount() {
                ...
                if (this.hasData()) {
                    if (m < d) {
                        for (n = this.min; g.length < d;) g.length % 2 || n === h ? g.push(p(g[g.length - 1] + b)) : g.unshift(p(g[0] - b));
                        this.transA *= (m - 1) / (d - 1);
            ...
            zoom: function zoom(a, b) {
                ...
                e(this, "zoom", a, function (a) {
                    ...
                    if (b !== this.min || d !== this.max) this.allowZoomOutside || (v(f) && (b < q && (b = q), b > m && (b = m)), v(g) && (d < q && (d = q), d > m && (d = m))), this.displayBtn = void 0 !== b || void 0 !== d, this.setExtremes(b, d, !1, void 0, {trigger: "zoom"});
                    a.zoomed = !0;
                });
                return a.zoomed;
            },
            ...
            unsquish: function unsquish() {
                var a = this.options.labels, b = this.horiz, g = this.tickInterval, d = g,
                    ...
                    n = this.labelMetrics(), c, u = Number.MAX_VALUE, z, l = this.max - this.min, x = function x(a) {
            ...
            getOffset: function getOffset() {
                var a = this, b = a.chart, g = b.renderer, d = a.options, m = a.tickPositions, h = a.ticks, n = a.horiz,
                    ...
                    A = d.labels, B = 0, p = b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][c], t = d.className,
                    y = a.axisParent;
                z = a.hasData();
                a.showAxis = l = z || E(d.showEmpty, !0);
                a.staggerLines = a.horiz && A.staggerLines;
                a.axisGroup || (a.gridGroup = g.g("grid").attr({zIndex: d.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (t || "")).add(y), a.axisGroup = g.g("axis").attr({zIndex: d.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (t || "")).add(y), a.labelGroup = g.g("axis-labels").attr({zIndex: A.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (t || "")).add(y));
        ...
        a.Tooltip.prototype = {
            init: function init(a, h) {
                ...
                l.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = t(d)[0].series.tooltipOptions.followPointer, g = this.getAnchor(d, h), h = g[0], n = g[1], !b || d.series && d.series.noSharedTooltip ? b = d.getLabelConfig() : (d.forEach(function (a) {
                    ...
                    x: d[0].category,
                    y: d[0].y
                }, b.points = x, d = d[0]), this.len = x.length, b = e.call(b, this), u = d.series, this.distance = p(u.tooltipOptions.distance, 16), !1 === b ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({opacity: 1}).show(), this.split ? this.renderSplit(b, t(c)) : (l.style.width && !k || e.css({width: this.chart.spacingBox.width}), e.attr({text: b && b.join ? b.join("") : b}), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + p(d.colorIndex, u.colorIndex)), k || e.attr({stroke: l.borderColor || d.color || u.color || "#666666"}), this.updatePosition({
                    plotX: h,
                    plotY: n,
                    negative: d.negative,
                    ttBelow: d.ttBelow,
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            init: function init(a, b) {
                ...
                var b = this.chart, g = b.options.chart, d = g.zoomType || "", b = b.inverted;
                ...
                d.axes.forEach(function (b) {
                    var d = l(b.crosshair.snap, !0), e = d ? a.find(m, function (a) {
                ...
                var b = this.chart, g = b.options.chart, d = a.chartX, e = a.chartY, c = this.zoomHor,
                    ...
                    q = this.selectionMarker, r = this.mouseDownX, p = this.mouseDownY,
                ...
                q && q.touch || (d < m ? d = m : d > m + l && (d = m + l), e < n ? e = n : e > n + A && (e = n + A), this.hasDragged = Math.sqrt(Math.pow(r - d, 2) + Math.pow(p - e, 2)), 10 < this.hasDragged && (f = b.isInsidePlot(r - m, p - n), b.hasCartesianSeries && (this.zoomX || this.zoomY) && f && !t && !q && (this.selectionMarker = q = b.renderer.rect(m, n, c ? 1 : l, h ? 1 : A, 0).attr({
                    ...
                    zIndex: 7
                }).add(), b.styledMode || q.attr({fill: g.selectionMarkerFill || k("#335cad").setOpacity(.25).get()})), q && c && (d -= r, q.attr({
                    width: Math.abs(d),
                    x: (0 < d ? 0 : d) + r
                })), q && h && (d = e - p, q.attr({
                    height: Math.abs(d),
                ...
                a = this.normalize(a);
                b.cancelClick || (d && this.inClass(a.target, "highcharts-tracker") ? (w(d.series, "click", t(a, {point: d})), b.hoverPoint && d.firePointEvent("click", a)) : (t(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - g, a.chartY - e) && w(b, "click", a)));
        ...
        F(a.Pointer.prototype, {
            pinchTranslate: function pinchTranslate(a, k, t, v, w, r) {
                ...
                var c = this.chart, n = a ? "x" : "y", d = a ? "X" : "Y", g = "chart" + d, b = a ? "width" : "height",
                    x = c["plot" + (a ? "Left" : "Top")], u, p, E = e || 1, B = c.inverted, m = c.bounds[a ? "h" : "v"],
                ...
                var c = this, t = c.chart, v = c.pinchDown, w = a.touches, r = w.length, h = c.lastValidTouch,
    ...
    (function (a) {
        ...
        if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var h = {}, e = !!w.PointerEvent, l = function l() {
                var d = [];
                d.item = function (a) {
                    return this[a];
                };
    ...
    (function (a) {
        ...
        a.Legend.prototype = {
            init: function init(a, d) {
                ...
                if (!this.chart.styledMode) {
                    var g = this.options, b = a.legendItem, e = a.legendLine, h = a.legendSymbol,
                        n = this.itemHiddenStyle.color, g = d ? g.itemStyle.color : n, l = d ? a.color || n : n,
                        k = a.options && a.options.marker, m = {fill: l};
                ...
                var d = this.options, e = d.symbolPadding, d = !d.rtl, b = a._legendItemPos, c = b[0], b = b[1],
                    h = a.checkbox;
                ...
                e.text && (this.title || (this.title = this.chart.renderer.label(e.text, d - 3, d - 4, null, null, null, a.useHTML, null, "legend-title").attr({zIndex: 1}), this.chart.styledMode || this.title.css(e.style), this.title.add(this.group)), e.width || this.title.css({width: this.maxLegendWidth + "px"}), a = this.title.getBBox(), b = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: b}));
                this.titleHeight = b;
                ...
                var d = this.chart, e = d.renderer, b = this.options, c = this.symbolWidth, h = b.symbolPadding,
                    n = this.itemStyle, l = this.itemHiddenStyle,
                    k = "horizontal" === b.layout ? w(b.itemDistance, 20) : 0, m = !b.rtl, z = a.legendItem,
                    D = !a.series, A = !D && a.series.drawLegendSymbol ? a.series : a, f = A.options,
                    f = this.createCheckboxForItem && f && f.showCheckbox, k = c + h + k + (f ? 20 : 0), q = b.useHTML,
                    r = a.options.className;
                z || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + A.type + "-series highcharts-color-" + a.colorIndex + (r ? " " + r : "") + (D ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = z = e.text("", m ? c + h : -h, this.baseline || 0, q), d.styledMode || z.css(v(a.visible ? n : l)), z.attr({
                    align: m ? "left" : "right",
                    zIndex: 2
                ...
                var d = this.options, e = this.padding, b = "horizontal" === d.layout, c = a.itemHeight,
                    h = d.itemMarginBottom || 0, n = this.itemMarginTop, l = b ? w(d.itemDistance, 20) : 0,
                ...
                var d = this, e = this.chart, b = e.renderer, c = this.options, h = c.y, n = this.padding,
                    ...
                    m = this.clipRect, z = c.navigation, D = w(z.animation, !0), r = z.arrowSize || 12, f = this.nav,
                    q = this.pages, p, t = this.allItems, v = function v(a) {
                ...
                a > h && !1 !== z.enabled ? (this.clipHeight = k = Math.max(h - 20 - this.titleHeight - n, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, t.forEach(function (a, b) {
                    ...
                    f !== p && (p = f);
                }), m || (m = d.clipRect = b.clipRect(0, n, 9999, 0), d.contentGroup.clip(m)), v(k), f || (this.nav = f = b.g().attr({zIndex: 1}).add(this.group), this.up = b.symbol("triangle", 0, 0, r, r).on("click", function () {
                    d.scroll(-1, D);
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function drawRectangle(a, d) {
                ...
                d.legendSymbol = this.chart.renderer.rect(b ? (a.symbolWidth - e) / 2 : 0, a.baseline - e + 1, b ? e : a.symbolWidth, e, w(a.options.symbolRadius, e / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(d.legendGroup);
    ...
    (function (a) {
        var y = a.addEvent, F = a.animate, G = a.animObject, k = a.attr, c = a.doc, p = a.Axis, t = a.createElement,
            v = a.defaultOptions, w = a.discardElement, r = a.charts, h = a.css, e = a.defined, l = a.extend,
            n = a.find, d = a.fireEvent, g = a.isNumber, b = a.isObject, x = a.isString, u = a.Legend,
            H = a.marginNames, E = a.merge, B = a.objectEach, m = a.Pointer, z = a.pick, D = a.pInt, A = a.removeEvent,
            f = a.seriesTypes, q = a.splat, L = a.syncTimeout, K = a.win, T = a.Chart = function () {
        ...
        l(T.prototype, {
            callbacks: [], getArgs: function getArgs() {
                ...
                ["title", "subtitle"].forEach(function (a) {
                    ...
                    var c;
                    f && (this.styledMode || (c = g.style.fontSize), c = d.fontMetrics(c, f).b, f.css({width: (g.width || e.width + g.widthAdjust) + "px"}).align(l({y: a + c}, g), !1, "spacingBox"), g.floating || g.verticalAlign || (b = Math.ceil(b + f.getBBox(g.useHTML).height)));
                }, this);
                ...
                var b = this.spacing, f = this.margin, g = this.titleOffset;
                this.resetMargins();
                ...
                var f = this, d = f.options.chart, g = f.renderTo, m = e(d.width) && e(d.height),
                    h = d.width || a.getStyle(g, "width"), d = d.height || a.getStyle(g, "height"),
                    g = b ? b.target : K;
                ...
                var a = this.options.chart, b = this.renderer, f = this.chartWidth, e = this.chartHeight,
        ...
        a.Point.prototype = {
            init: function init(a, c, h) {
                ...
                var c = {}, h = this.series, d = h.options.keys, g = d || h.pointArrayMap || ["y"], b = g.length, k = 0,
                    u = 0;
                if (t(e) || null === e) c[g[0]] = e; else if (p(e)) for (!d && e.length > b && (h = typeof e[0], "string" === h ? c.name = e[0] : "number" === h && (c.x = e[0]), k++); u < b;) d && void 0 === e[k] || (0 < g[u].indexOf(".") ? a.Point.prototype.setNestedProperty(c, e[k], g[u]) : c[g[u]] = e[k]), k++ , u++; else "object" === typeof e && (c = e, e.dataLabels && (h._hasPointLabels = !0), e.marker && (h._hasPointMarkers = !0));
                return c;
    ...
    (function (a) {
        var y = a.addEvent, F = a.animObject, G = a.arrayMax, k = a.arrayMin, c = a.correctFloat, p = a.defaultOptions,
            t = a.defaultPlotOptions, v = a.defined, w = a.erase, r = a.extend, h = a.fireEvent, e = a.isArray,
            l = a.isNumber, n = a.isString, d = a.merge, g = a.objectEach, b = a.pick, x = a.removeEvent, u = a.splat,
            H = a.SVGElement, E = a.syncTimeout, B = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            setOptions: function setOptions(a) {
                var e = this.chart, g = e.options, c = g.plotOptions, f = (e.userOptions || {}).plotOptions || {},
                    m = c[this.type], l = d(a);
                a = e.styledMode;
            ...
            setData: function setData(d, g, c, h) {
                var f = this, m = f.points, k = m && m.length || 0, z, u = f.options, r = f.chart, D = null,
                    x = f.xAxis, A = u.turboThreshold, p = this.xData, B = this.yData,
                    t = (z = f.pointArrayMap) && z.length, v = u.keys, E = 0, w = 1, H;
                d = d || [];
                z = d.length;
                g = b(g, !0);
                ...
                if (!H) {
                    ...
                    if (A && z > A) {
                        ...
                        if (l(D)) for (c = 0; c < z; c++) p[c] = this.autoIncrement(), B[c] = d[c]; else if (e(D)) if (t) for (c = 0; c < z; c++) D = d[c], p[c] = D[0], B[c] = D.slice(1, t + 1); else for (v && (E = v.indexOf("x"), w = v.indexOf("y"), E = 0 <= E ? E : 0, w = 0 <= w ? w : 1), c = 0; c < z; c++) D = d[c], p[c] = D[E], B[c] = D[w]; else a.error(12, !1, r);
            ...
            generatePoints: function generatePoints() {
                var a = this.options, b = a.data, d = this.data, e, f = this.processedXData, c = this.processedYData,
                    g = this.pointClass, l = f.length, k = this.cropStart || 0, n, x = this.hasGroupedData, a = a.keys,
                    p, B = [], t;
                d || x || (d = [], d.length = b.length, d = this.data = d);
                a && x && (this.options.keys = !1);
                for (t = 0; t < l; t++) n = k + t, x ? (p = new g().init(this, [f[t]].concat(u(c[t]))), p.dataGroup = this.groupMap[t], p.dataGroup.options && (p.options = p.dataGroup.options, r(p, p.dataGroup.options), delete p.dataLabels)) : (p = d[n]) || void 0 === b[n] || (d[n] = p = new g().init(this, b[n], f[t])), p && (p.index = n, B[t] = p);
                this.options.keys = a;
            ...
            translate: function translate() {
                ...
                this.generatePoints();
                var a = this.options, d = a.stacking, e = this.xAxis, g = e.categories, f = this.yAxis, q = this.points,
                    k = q.length, n = !!this.modifyValue, u, r = this.pointPlacementToXValue(), x = l(r),
                    p = a.threshold, B = a.startFromThreshold ? p : 0, t, E, w, H, y = this.zoneAxis || "y",
                    G = Number.MAX_VALUE;
                for (u = 0; u < k; u++) {
            ...
            destroy: function destroy(b) {
                var d = this, e = d.chart, c = /AppleWebKit\/533/.test(B.navigator.userAgent), f, m, l = d.data || [],
                    k, n;
                h(d, "destroy");
                b || x(d);
        ...
        w.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var c = this.processedXData, h = this.processedYData, e = [], l = h.length, n = this.options,
                    d = n.threshold, g = v(n.startFromThreshold && d, 0), b = n.stack, n = n.stacking,
                    x = this.stackKey, u = "-" + x, p = this.negStacks, t = this.yAxis, B = t.stacks, m = t.oldStacks,
                    z, D, A, f, q, w, y;
                t.stacksTouched += 1;
    ...
    (function (a) {
        ...
        w(k.prototype, {
            ...
            showLoading: function showLoading(a) {
                var b = this, d = b.options, e = b.loadingDiv, g = d.loading, f = function f() {
                    e && p(e, {
                        left: b.plotLeft + "px",
                        top: b.plotTop + "px",
            ...
            update: function update(b, e, c, l) {
                var m = this, f = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, k, u, p, x = [];
        ...
        w(x.prototype, {
            addPoint: function addPoint(a, b, d, e) {
                ...
                var e = this, c = e.data, f = c[a], h = e.points, m = e.chart, l = function l() {
                ...
                var e = this, c = e.chart, h = e.userOptions, f = e.initialType || e.type,
                    m = b.type || h.type || c.options.chart.type, l = u[f].prototype, k,
    ...
    (function (a) {
        ...
        k("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function getStackPoints(c) {
                var k = [], t = [], v = this.xAxis, w = this.yAxis, r = w.stacks[this.stackKey], h = {}, e = this.index,
                    l = w.series, n = l.length, d, g = F(w.options.reversedStacks, !0) ? 1 : -1, b;
                c = c || this.points;
                if (this.options.stacking) {
                    ...
                    t.forEach(function (a, c) {
                        ...
                        if (h[a] && !h[a].isNull) k.push(h[a]), [-1, 1].forEach(function (l) {
                            ...
                            if (x) for (b = e; 0 <= b && b < n;) u = x.points[b], u || (b === e ? h[a][k] = !0 : d[b] && (p = r[a].points[b]) && (m -= p[1] - p[0])), b += g;
                ...
                var c = G.prototype.getGraphPath, k = this.options, v = k.stacking, w = this.yAxis, r, h, e = [],
                    ...
                    x = w.getThreshold(k.threshold), u, k = k.connectNulls || "percent" === v, H = function H(c, h, k) {
                        var m = a[c];
                        c = v && g[m.x].points[n];
                        var u = m[k + "Null"] || 0;
                        k = m[k + "Cliff"] || 0;
        ...
        w("column", "line", {
            ...
            getColumnMetrics: function getColumnMetrics() {
                ...
                var u = Math.min(Math.abs(c.transA) * (c.ordinalSlope || e.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                    r = u * e.groupPadding, v = (u - 2 * r) / (p || 1),
            ...
            translate: function translate() {
                ...
                a.points.forEach(function (c) {
                    var h = t(c.yBottom, b), l = 999 + Math.abs(h), m = r,
                        l = Math.min(Math.max(-l, c.plotY), d.len + l), f = c.plotX + B, n = E, u = Math.min(l, h), x,
                        v = Math.max(l, h) - u;
            ...
            animate: function animate(a) {
                ...
                r && (a ? (g.scaleY = .001, a = Math.min(c.pos + c.len, Math.max(c.pos, c.toPixels(h.threshold))), d ? g.translateX = a - c.len : g.translateY = a, e.clipBox && e.setClip(), e.group.attr(g)) : (k = e.group.attr(b), e.group.animate({scaleY: 1}, G(y(e.options.animation), {
    ...
    (function (a) {
        var y = a.deg2rad, F = a.isNumber, G = a.pick, k = a.relativeLength;
        ...
        r("pie", "line", {
            ...
            animate: function animate(a) {
                ...
                a || (c.forEach(function (a) {
                    ...
                    b && (b.attr({r: a.startR || e.center[3] / 2, start: d, end: d}), b.animate({
                        r: c.r,
                        start: c.start,
                        end: c.end
                    }, e.options.animation));
            ...
            drawPoints: function drawPoints() {
                ...
                a.points.forEach(function (e) {
                    ...
                    if (e.isNull) g && (e.graphic = g.destroy()); else {
                        ...
                        g ? (g.setRadialReference(a.center), c.styledMode || g.attr(b), g.animate(k(p, d))) : (e.graphic = g = h[e.shapeType](p).setRadialReference(a.center).attr(d).add(a.group), c.styledMode || g.attr(b).attr({"stroke-linejoin": "round"}).shadow(u, l));
    ...
    (function (a) {
        var y = a.addEvent, F = a.arrayMax, G = a.defined, k = a.extend, c = a.format, p = a.merge, t = a.noop,
            v = a.pick, w = a.relativeLength, r = a.Series, h = a.seriesTypes, e = a.stableSort, l = a.isArray,
            n = a.splat;
        a.distribute = function (d, c, b) {
            ...
            for (d = d.map(function (a) {
                ...
                for (h = d.length; h--;) k = d[h], m = (Math.min.apply(0, k.targets) + Math.max.apply(0, k.targets)) / 2, k.pos = Math.min(Math.max(0, m - k.size * k.align), c - k.size);
                h = d.length;
        ...
        r.prototype.drawDataLabels = function () {
            ...
            if (l(r) || r.enabled || b._hasPointLabels) z = b.plotGroup("dataLabelsGroup", "data-labels", D && !m ? "hidden" : "visible", r.zIndex || 6), D && (z.attr({opacity: +m}), m || y(b, "afterAnimate", function () {
                b.visible && z.show(!0);
        ...
        r.prototype.alignDataLabel = function (a, e, b, c, h) {
            var d = this.chart, g = this.isCartesian && d.inverted, l = v(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                m = v(a.plotY, -9999), n = e.getBBox(), u, p = b.rotation, f = b.align,
            ...
            if (q && (u = d.renderer.fontMetrics(d.styledMode ? void 0 : b.style.fontSize, e).b, c = k({
                ...
                y: c.y + b.y + ({top: 0, middle: .5, bottom: 1})[b.verticalAlign] * c.height
        ...
        h.pie && (h.pie.prototype.dataLabelPositioners = {
            ...
            var d = this, e = d.data, b, c = d.chart, h = d.options.dataLabels, k = h.connectorPadding,
                ...
                t = Math.round(c.chartWidth / 3), w, f = d.center, q = f[2] / 2, y = f[1], K, I, J, M, R = [[], []], C,
                P, N, S, O = [0, 0, 0, 0], W = d.dataLabelPositioners;
    ...
    (function (a) {
        ...
        y.prototype.hideOverlappingLabels = function (a) {
            var c = this, k = a.length, r = c.renderer, h, e, l, n, d, g, b = function b(a, _b, c, d, e, g, h, k) {
    ...
    (function (a) {
        ...
        x = a.TrackerMixin = {
            drawTrackerPoint: function drawTrackerPoint() {
                var a = this, b = a.chart, c = b.pointer, d = function d(a) {
        ...
        t(n.prototype, {
            select: function select(a, b) {
                ...
                var c = Math.floor(this.plotX), d = this.plotY, e = this.series,
                    ...
                    r = e.stateMarkerGraphic, u = this.marker || {}, w = e.chart, x = e.halo, y,
                    F = h && e.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (n || k && !1 === f.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
                    ...
                    (c = g.halo) && c.size ? (x || (e.halo = x = w.renderer.path().add((this.graphic || r).parentGroup)), x.show()[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), x.attr({
        ...
        t(d.prototype, {
            onMouseOver: function onMouseOver() {
                ...
                var b = this, c = b.options, d = b.graph, e = c.states, g = c.lineWidth, c = 0;
                a = a || "";
                if (b.state !== a && ([b.group, b.markerGroup, b.dataLabelsGroup].forEach(function (c) {
                    c && (b.state && c.removeClass("highcharts-series-" + b.state), a && c.addClass("highcharts-series-" + a));
                }), b.state = a, !(b.chart.styledMode || e[a] && !1 === e[a].enabled) && (a && (g = e[a].lineWidth || g + (e[a].lineWidthPlus || 0)), d && !d.dashstyle))) for (g = {"stroke-width": g}, d.animate(g, l(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(g), c += 1;
    ...
    (function (a) {
        ...
        y.prototype.setResponsive = function (c, k) {
            var p = this.options.responsive, t = [], r = this.currentResponsive;
        ...
        y.prototype.currentOptions = function (k) {
            function p(k, r, h, e) {
                ...
                a.objectEach(k, function (a, d) {
                    if (!e && -1 < ["series", "xAxis", "yAxis"].indexOf(d)) for (a = c(a), h[d] = [], l = 0; l < a.length; l++) r[d][l] && (h[d][l] = {}, p(a[l], r[d][l], h[d][l], e + 1)); else G(a) ? (h[d] = F(a) ? [] : {}, p(a, r[d] || {}, h[d], e + 1)) : h[d] = r[d] || null;
                });
            }
